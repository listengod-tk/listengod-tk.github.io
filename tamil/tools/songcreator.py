...
#           "genre": "OLD",
#           "goodreads": {
#               "url": "blue-playlist/Genesis.html",
#               "image": "1.png",
#               "myreview": "blue-playlist/Genesis.html",
#               "genre": "OLD"
#           }
...
bib=[]
for i in chapters:
	if chapters.index(i)<=38:
		chp = {"title": i,"author": i,"genre": "OLD","goodreads": {	"url": "blue-playlist/"+i.strip()+".html","image": str(j+1)+".png","myreview": "blue-playlist/"+i.strip()+".html","genre": "OLD"}}
		bib.append(json.dumps(chp))
		j=j+1
	else:
		chp = {"title": i,"author": i,"genre": "NEW","goodreads": {	"url": "blue-playlist/"+i.strip()+".html","image": str(j+1)+".png","myreview": "blue-playlist/"+i.strip()+".html","genre": "NEW"}}
		bib.append(json.dumps(chp))
		j=j+1
print(str(bib).replace("'",""))
